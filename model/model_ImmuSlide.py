...
class Attn_Net_Gated(nn.Module):
    ...
    def __init__(self, L = 1536, D = 256, dropout = False, n_tasks = 1):
...
class ImmuSlide(nn.Module):
    def __init__(self, gate=True, size_arg="big", dropout=False, n_classes=2):
        super(ImmuSlide, self).__init__()
        self.size_dict = {"small": [1536, 512, 256], "big": [1536, 512, 384]}
        size = self.size_dict[size_arg]
